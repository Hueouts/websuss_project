...
export default function Ultra() {
    ...
    const [specContCrea,setspecContCrea] = useState();
    const [immWebLaunch,setimmWebLaunch] = useState();
    const [prefContCreation,setprefContCreation] = useState();
    const [asstPhoVid,setasstPhoVid] = useState();
   ...
   const [vipSup,setvipSup] = useState();
    const [seoKeyWord, setSeoKeyWords] = useState();
    const [domainName, setDomainName] = useState();
    const [domainEmail, setDomainEmail] = useState();
    const [exstSocialMarketing,setexstSocialMarketing] = useState();
    const [addUpdCont,setaddUpdCont] = useState();
    const [topicFocSeo, settopicFocSeo] = useState();
    const [copyWriteServ,setcopyWriteServ] = useState();
    const [onlinePres, setonlinePres] = useState();
    const [expcAdvSeo, setexpcAdvSeo] = useState();
    const [intiPromo, setintiPromo] = useState();
    const [haveCamp,sethaveCamp] = useState();
    const [vipPhoneSup,setvipPhoneSup] = useState();
    const [vipEmailSup,setvipEmailSup] = useState();
    ...
    // useEffect(() => {
    //     async function checkOrder() {
    //         await axios.get(`https:www.websuss.com/order/${user_id}`)
    //             .then((x) => {
    //                 if (x.data.order) {
    //                   const ui =  Cookies.setItem('websussOrder', JSON.stringify(x.data.result))
    //                   if(ui){
    //                     setTimeout(() => {
    //                         navigate('/my-account')
    //                     }, 1000);
    ...
    const handleProductImgChange = (event) => {
        ...
        if (productImg.length > 9 || fileArray.length > 10) {
            setProductImg([]);
            setWar(true);
            return;
        }
    ...
    const handelQuestionSubmit = async (e) => {
        ...
        const obj = {
            ...
            comp_bio: companyBio,
            key_word: keyWords,
            spec_cont_crea:specContCrea,
            imm_web_launch:immWebLaunch,
            pref_cont_creation:prefContCreation,
            asst_pho_vid:asstPhoVid,
            ...
            exst_social_marketing:exstSocialMarketing,
            add_upd_cont:addUpdCont,
            topic_foc_seo:topicFocSeo,
            copy_write_serv:copyWriteServ,
            online_pres:onlinePres,
            expc_adv_seo:expcAdvSeo,
            inti_promo:intiPromo,
            have_camp:haveCamp,
            vip_phone_sup:vipPhoneSup,
            vip_email_sup:vipEmailSup,
            add_info:addInfo,
            orderDate: orderDate
        };
        ...
        <div className='core-plan '>
            ...
            <div className='core-main flx-c'>
                ...
                <div className='core-heading'>
                    <h2>
                        Ultra  Package<br /> Questionnaire
                    ...
                    <div>
                        <div className='prog flx-r'>
                            <div className='for-prog'>
                                ...
                                <div><span onClick={() => { setNext(8) }}><i className={next >= 8 ? "fa-solid fa-circle" : "fa-regular fa-circle"}></i></span></div>
                                <div><span onClick={() => { setNext(9) }}><i className={next >= 9 ? "fa-solid fa-circle" : "fa-regular fa-circle"}></i></span></div>
                                <div><span onClick={() => { setNext(10) }}><i className={next >= 10 ? "fa-solid fa-circle" : "fa-regular fa-circle"}></i></span></div>
                                <div><span onClick={() => { setNext(11) }}><i className={next >= 11 ? "fa-solid fa-circle" : "fa-regular fa-circle"}></i></span></div>
                                <div><span onClick={() => { setNext(12) }}><i className={next >= 12 ? "fa-solid fa-circle" : "fa-regular fa-circle"}></i></span></div>
                            </div>
                        </div>
                            ...
                            {next === -1 && (
                                    ...
                                    <section className="form-section " id="step3">
                                        ...
                                        <div>
                                            ...
                                            <div>
                                                ...
                                                <br />
                                                {war && (<span className='b-warn'>maximum 10 products allowed in Ultra Plan</span>)}
                                                <div>
                                            ...
                                            <div>
                                                <label htmlFor="keywords">Do you have any specific content creation requests (e.g., blog posts, product descriptions)? <span>*</span></label>
                                                <br /><textarea required type="text" value={specContCrea} onChange={(e) => { setspecContCrea(e.target.value) }} id="keywords" placeholder="Describe Your Specific Content Creation." />
                                            </div>
                                            <div>
                                                <label htmlFor="keywords">Do you have any content ready for immediate website launch? <span>*</span></label>
                                                <br /><textarea required type="text" value={immWebLaunch} onChange={(e) => { setimmWebLaunch(e.target.value) }} id="keywords" placeholder="Write Content Here." />
                                            </div>
                                            <div>
                                                <label htmlFor="keywords">What is your preferred content creation schedule (e.g., monthly blog posts)? <span>*</span></label>
                                                <br /><textarea required type="text" value={prefContCreation} onChange={(e) => { setprefContCreation(e.target.value) }} id="keywords" placeholder="Describe Your Preferred Content Creation." />
                                            </div>
                                            <div>
                                                <label htmlFor="keywords">Do you need any assistance with professional photography or videography? <span>*</span></label>
                                                <br /><textarea required type="text" value={asstPhoVid} onChange={(e) => { setasstPhoVid(e.target.value) }} id="keywords" placeholder="Describe Here." />
                                            </div>
                                            <div className="form-buttons flx-r flx-r">
                                                <button type="button" className="previous" onClick={prev}>Previous</button>
                                                <button type="button" className="save-draft">Save as Draft</button>
                                                <button type="button" className="next"
                                                 onClick={
                                                    ()=>{
                                                        if(!targetAud || !companyBio || !keyWords || !productImg || !specContCrea || !immWebLaunch || !prefContCreation || !asstPhoVid){
                                                            setDta(true);
                                                            return;
                                                        }else{
                                                        nxt()}
                                ...
                                {next === 6 && (
                                    <section className="form-section " id="step5">
                                        ...
                                        <div>
                                            ...
                                            <div>
                                                <label htmlFor="social-media">What is the preferred contact method for VIP support from Websuss?  <span>*</span></label>
                                                <div> <textarea required id="description" value={vipSup} onChange={(e) => { setvipSup(e.target.value) }} placeholder="Method For VIP Support." />
                                                </div></div>
                                            <div className="form-buttons flx-r">
                                                <button type="button" className="previous" onClick={prev}>Previous</button>
                                                <button type="button" className="save-draft">Save as Draft</button>
                                                <button type="button" className="next" onClick={
                                                    ()=>{
                                                        if(!businessEmail || !businessPhone || !socialMediaLink || !vipSup ){
                                                            setDta(true);
                                                            return;
                                                        }else{
                                                        nxt()}}
                                ...
                                {next === 7 && (
                                    ...
                                    <section className="form-section " id="step6">
                                        ...
                                        <div>
                                            ...
                                            <div>
                                                <label htmlFor="additional-info">Do you have any existing social media marketing campaigns you want us to analyze and integrate? <span>*</span></label>
                                                <br /><textarea required type="text" value={exstSocialMarketing} onChange={(e) => { setexstSocialMarketing(e.target.value) }} id="additional-info" placeholder="Provide Details Here..." />
                                            </div>

                                            <div>
                                                <label htmlFor="additional-info">How often do you plan to add or update content on your site? <span>*</span></label>
                                                <br /><textarea required type="text" value={addUpdCont} onChange={(e) => { setaddUpdCont(e.target.value) }} id="additional-info" placeholder="Describe Here..." />
                                            </div>

                                            <div>
                                                <label htmlFor="additional-info">Please provide us with a list of topics you want to focus on for SEO. (For blog content) <span>*</span></label>
                                                <br /><textarea required type="text" value={topicFocSeo} onChange={(e) => { settopicFocSeo(e.target.value) }} id="additional-info" placeholder="List All Topics." />
                                            </div>
                                            <div className="form-buttons flx-r">
                                                <button type="button" className="previous" onClick={prev}>Previous</button>
                                                <button type="button" className="save-draft">Save as Draft</button>
                                                <button type="button" className="next"
                                                 onClick={()=>{
                                                    if(!seoKeyWord || !domainName || !domainEmail || !exstSocialMarketing || !addUpdCont || !topicFocSeo){
                                                        setDta(true);
                                                        return;
                                                    }else{
                                                    nxt()}}}>Next</button>
                                ...
                                {next === 8 && (
                                    ...
                                    <section className="form-section " id="step6">
                                        ...
                                        <div>
                                            <label htmlFor="additional-info">Do you have any existing written content you want us to integrate, or do you need copywriting services? (Provide/Need Services) <span>*</span></label>
                                            <br /><textarea required type="text" value={copyWriteServ} onChange={(e) => { setcopyWriteServ(e.target.value) }} id="additional-info" placeholder="List All Topics." />
                                        </div>
                                        <div className="form-buttons flx-r">
                                            <button type="button" className="previous" onClick={prev}>Previous</button>
                                            <button type="button" className="save-draft">Save as Draft</button>
                                ...
                                {next === 9 && (
                                    ...
                                    <section className="form-section " id="step6">
                                        <h2>Business Growth and Strategy:</h2>
                                        <div>
                                            <label htmlFor="additional-info">Describe how you aim to grow your business through your online presence.  <span>*</span></label>
                                            <br /><textarea required type="text" value={onlinePres} onChange={(e) => { setonlinePres(e.target.value) }} id="additional-info" placeholder="Describe Here.." />
                                        </div>
                                        <div>
                                            <label htmlFor="additional-info">What specific outcomes do you expect from advanced SEO and social media promotion?<span>*</span></label>
                                            <br /><textarea required type="text" value={expcAdvSeo} onChange={(e) => { setexpcAdvSeo(e.target.value) }} id="additional-info" placeholder="Describe Here.." />
                                        </div>
                                        <div className="form-buttons flx-r">
                                            <button type="button" className="previous" onClick={prev}>Previous</button>
                                            <button type="button" className="save-draft">Save as Draft</button>
                                ...
                                {next === 10 && (
                                    ...
                                    <section className="form-section " id="step6">
                                        ...
                                        <div>
                                            <label htmlFor="additional-info">Which social media platforms are you looking to integrate and promote on?  <span>*</span></label>
                                            <br /><textarea required type="text" value={intiPromo} onChange={(e) => { setintiPromo(e.target.value) }} id="additional-info" placeholder="e.g. (facebook, instagram, twitter)" />
                                        </div>
                                        <div>
                                            <label htmlFor="additional-info">Do you have any specific campaigns or promotions in mind that we should prepare for? <span>*</span></label>
                                            <br /><textarea required type="text" value={haveCamp} onChange={(e) => { sethaveCamp(e.target.value) }} id="additional-info" placeholder="Describe Here.." />
                                        </div>
                                        <div className="form-buttons flx-r">
                                            <button type="button" className="previous" onClick={prev}>Previous</button>
                                            <button type="button" className="save-draft">Save as Draft</button>
                                ...
                                {next === 11 && (
                                    ...
                                    <section className="form-section " id="step6">
                                        ...
                                        <div>
                                            <label htmlFor="additional-info">What are your expectations regarding VIP phone support?  <span>*</span></label>
                                            <br /><textarea required type="text" value={vipPhoneSup} onChange={(e) => { setvipPhoneSup(e.target.value) }} id="additional-info" placeholder="Describe Your Expectations" />
                                        </div>
                                        <div>
                                            <label htmlFor="additional-info">What are your expectations regarding VIP email support? <span>*</span></label>
                                            <br /><textarea required type="text" value={vipEmailSup} onChange={(e) => { setvipEmailSup(e.target.value) }} id="additional-info" placeholder="Describe Here.." />
                                        </div>
                                        <div className="form-buttons flx-r">
                                            <button type="button" className="previous" onClick={prev}>Previous</button>
                                            <button type="button" className="save-draft">Save as Draft</button>
                                            <button type="button" className="next" onClick={()=>{
                                                if(!vipPhoneSup || !vipEmailSup){
                                                    setDta(true)
                                                    return;
                                                }else{
                                                nxt()}}}>Next</button>
                                ...
                                {next === 12 && (
                                    ...
                                    <section className="form-section " id="step6">
                                        ...
                                        <div>
                                            ...
                                            <br /><textarea required type="text" value={addInfo} onChange={(e) => { setaddInfo(e.target.value) }} id="additional-info" placeholder="Any Additional Note." />
                                        </div>
                                        <div className="form-buttons flx-r">
                                            <button type="button" className="previous" onClick={prev}>Previous</button>
